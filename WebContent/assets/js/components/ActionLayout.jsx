...
export default class ActionLayout extends React.Component {
    ...
    signOut() {
        console.log(this.props.route.userRole + ',' + this.props.route.userRole[0])
        Modal.confirm({
            title: '您确认要退出管理系统？',
                ...
                <Menu theme={'dark'} onClick={this.handleClick} style={{
                  ...
                  {this.props.route.userRole - 0 === 1111
                    ? <SubMenu key="manage" title={< span > <Icon type="setting"/> < span > 系统管理 < /span></span >}>
                      ...
                      <Menu.Item key="searchConfig">搜索平台设置</Menu.Item>
